...
''';
  ...
  Future<void> _pollStatus() async {
    final status = await FirebaseService.getOrderStatus(widget.orderId);
    if (!mounted || status == null) return;
    if (_statusOrder.contains(status) && status != _orderStatus) {
                ...
                Container(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(widget.riderName.isEmpty ? 'Assigning rider...' : widget.riderName,
