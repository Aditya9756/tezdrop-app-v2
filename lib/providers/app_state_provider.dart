...
class AppStateProvider extends ChangeNotifier {
  ...
  Future<bool> placeOrder() async {
    ...
    // Firebase se real riders fetch karo, fallback hardcoded list
    final riderData = await FirebaseService.getAvailableRider();
    final rider      = riderData?['name']  as String? ??
        AppStrings.riders[DateTime.now().millisecond % AppStrings.riders.length];
    final riderPhone = riderData?['phone'] as String? ?? AppStrings.supportPhone;
